...
Scan outcome: **complete**. The register is bounded by the manifest's declared scope.
...
Documentation: linked-evidence (assessed). Tests: linked-evidence (assessed).
...
Documentation: no-linked-evidence (assessed). Tests: no-linked-evidence (assessed).
...
**open**: No linked test evidence was found for Administrative audit export in the inspected scope.

Review admin-export and add an explicit test association, or record a justified waiver.
